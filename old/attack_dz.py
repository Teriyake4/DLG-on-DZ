...
class Args:
    def __init__(self, p, mu):
        ...
        self.network = "resnet20" # lenet, resnet20
        self.sparsity = p # p
...
def main(args):
    ...
    save_path = os.path.join(root_path, f'results/DLG_gt_label_trained/DLG_{dataset}_p{args.sparsity}_mu{args.zoo_step_size}').replace('\\', '/')
    ...
    for idx_net in range(num_exp):
        ...
        net = net.to(device) # cuda runs out of memory
        ...
        # for method in ['iDLG']:
            ...
            for iters in range(Iteration):
                ...
                def closure():
                    ...
                    # print(pred)
                    if method == 'DLG':
                        # print(dummy_label.dtype, pred.dtype)
